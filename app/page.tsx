      ...
      <div className="absolute top-20 left-10 animate-float">
        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">
            AI-Pow bejegyzésgenerálás a közösségi oldalkra.
          </h1>
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
          Hozzon létre vonzó tartalmat a Twitter, az Instagram vagy a LinkedIn oldalain az
          élvonalbeli AI technológiával.
          </p>
          <div className="flex justify-center space-x-4">
            ...
            >
              <Link href="/generate">Generálás</Link>
            </Button>
            <Button
              asChild
            ...
            >
              <Link href="#features">Tovább olvas</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="py-20" id="features">
          ...
          Turbózza fel jelenlétét a közösségi médiában
          </h2>
            ...
            {[
              {
                ...
                description:
                  "Hozzon létre vonzó Twitter-bejegyzéseket, amelyek megfogják közönségét és növelik elérését.",
              },
              {
                title: "Instagram",
                icon: (
                ...
                description:
                  "Hozzon létre lenyűgöző feliratokat Instagram-bejegyzéseihez, amelyek növelik az érdeklődést és a követőket.",
              },
              {
                title: "LinkedIn",
                icon: <LinkedinIcon className="w-10 h-10 mb-4 text-blue-600" />,
                description:
                  "Készítsen professzionális tartalmat LinkedIn fiókja számára a figyyelemfelkeltés megalapozásához.",
              },
            ].map((feature, index) => (
              <div
                key={index}
        ...
        <div className="py-20 bg-gray-900 rounded-3xl my-20 relative">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                "Takarítson meg időt és energiát a tartalom létrehozásával",
                "Folyamatosan létrehozhat kiváló minőségű bejegyzéseket",
                "Növelje az jelenlétét minden platformon",
                "Előzze meg a közösségi média trendjeit",
                "A tartalom testreszabása az ön igényeinek megfelelően",
                "Szabályozza jelenlétét könnyedén a közösségi médiában",
              ].map((benefit, index) => (
        ...
        <div className="text-center py-20 relative">
          ...
          Készen állsz arra, hogy forradalmasítsd a közösségi média stratégiádat?
          </h2>
          {userId ? (
            <Button
              asChild
            ...
            >
              <Link href="/generate">
                Indulás most! <ArrowRightIcon className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          ) : (
            <SignUpButton mode="modal">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-full text-lg transition duration-300 ease-in-out transform hover:scale-105">
                Ingyenes indulás <ArrowRightIcon className="ml-2 h-5 w-5" />
              </Button>
            </SignUpButton>
          )}
          <p className="mt-4 text-gray-400">Nincs szükség hitelkártyára</p>
        </div>
