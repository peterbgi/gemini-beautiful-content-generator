...
export default function GenerateContent() {
  ...
  useEffect(() => {
    if (!apiKey) {
      console.error("Gemini API kulcs nem jó.");
    }
  }, []);
  ...
  useEffect(() => {
    if (isLoaded && !isSignedIn) {
      ...
      console.log("Felhasználó betöltése:", user);
      fetchUserPoints();
      fetchContentHistory();
    }
  ...
  const fetchUserPoints = async () => {
    if (user?.id) {
      console.log("Fwlhasználói pontok:", user.id);
      const points = await getUserPoints(user.id);
      console.log("Pontok:", points);
      setUserPoints(points);
      if (points === 0) {
        console.log("Nincs pontja a felhasználónak.");
        const updatedUser = await createOrUpdateUser(
          user.id,
          user.emailAddresses[0].emailAddress,
          user.fullName || ""
        );
        console.log("Felhasználó frissitve:", updatedUser);
        if (updatedUser) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      let promptText = `Generálás ${contentType} szöveg "${prompt}".`;
      ...
      console.error("Hibás generálás:", error);
      setGeneratedContent(["Hibás generálás."]);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="flex items-center justify-center min-h-screen bg-[#0a0a0a]">
        <div className="text-center bg-[#111111] p-8 rounded-lg shadow-lg">
          ...
          <p className="text-gray-400 mb-6">
            Kezdj bele a lélegzetelállító tartalmak gyártásába.
          </p>
          ...
          A belépésel elfogadod a felhasználási feltételeket.
          </p>
        </div>
      </div>
    );
        ...
        <div className="grid grid-cols-1 mt-14 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-gray-800 rounded-2xl p-6 h-[calc(100vh-12rem)] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-blue-400">Elözmények</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-800 p-6 rounded-2xl flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm text-gray-400">Pontjaim</p>
            ...
            <div className="bg-gray-800 p-6 rounded-2xl space-y-6">
              ...
              <div>
                ...
                <Textarea
                  id="prompt"
                  placeholder="Ide írhatod miről legyen szó..."
                  value={prompt}
              ...
              >
                {isLoading ? (
                  ...
                  `Készít (${POINTS_PER_GENERATION} pont)`
                )}
              </Button>
            </div>
